...
// todo crz: this is a bit hacky
#define NAMESPACED(NS, NAME) _##NS##_##NAME
...
// todo crz: possibly namespace this, incase there are two classes of same type
#define _6IT_DESTRUCTOR(T, NS) _6IT_PRIVATE void _##NS##_destruct(struct T##_t* _This)
#define _6IT_THISCALL_DIE(T, NS) _6IT_PRIVATE void _##NS##_die(struct T##_t* _This, int fault_code, char const *message)
#define _6IT_THISCALL_GET_ERROR_STRING(T, NS) _6IT_PRIVATE char const *_##NS##_get_error_string(struct T##_t* _This, int error)
...
#define PRIVATE_METHOD(TYPE, NAMESPACE, R, NAME) _6IT_PRIVATE R _6IT_THISCALL(TYPE, NAME)
#define PRIVATE_METHODX(TYPE, NAMESPACE, R, NAME, PARM) _6IT_PRIVATE R _6IT_THISCALLX(TYPE, _##NAMESPACE##_##NAME, PARM)
#define PRIVATE_METHODXX(TYPE, NAMESPACE, R, NAME, P1, P2) _6IT_PRIVATE R _6IT_THISCALLXX(TYPE, _##NAMESPACE##_##NAME, P1, P2)
#define PRIVATE_METHODXXX(TYPE, NAMESPACE, R, NAME, P1, P2, P3) _6IT_PRIVATE R _6IT_THISCALLXXX(TYPE, _##NAMESPACE##_##NAME, P1, P2, P3)
#define PRIVATE_METHODXXXX(TYPE, NAMESPACE, R, NAME, P1, P2, P3, P4) _6IT_PRIVATE R _6IT_THISCALLXXXX(TYPE, _##NAMESPACE##_##NAME, P1, P2, P3, P4)

#define NAMESPACED_METHOD(TYPE, NAMESPACE, R, NAME) _6IT_PRIVATE R _6IT_THISCALL(TYPE, _##NAMESPACE##_##NAME)
#define NAMESPACED_METHODX(TYPE, NAMESPACE, R, NAME, PARM) _6IT_PRIVATE R _6IT_THISCALLX(TYPE, _##NAMESPACE##_##NAME, PARM)
#define NAMESPACED_METHODXX(TYPE, NAMESPACE, R, NAME, P1, P2) _6IT_PRIVATE R _6IT_THISCALLXX(TYPE, _##NAMESPACE##_##NAME, P1, P2)
#define NAMESPACED_METHODXXX(TYPE, NAMESPACE, R, NAME, P1, P2, P3) _6IT_PRIVATE R _6IT_THISCALLXXX(TYPE, _##NAMESPACE##_##NAME, P1, P2, P3)
#define NAMESPACED_METHODXXXX(TYPE, NAMESPACE, R, NAME, P1, P2, P3, P4) _6IT_PRIVATE R _6IT_THISCALLXXXX(TYPE, _##NAMESPACE##_##NAME, P1, P2, P3, P4)

#define MACHINE_METHOD(R, NAME) R _6IT_THISCALL(machine, NAME)
#define MACHINE_METHODX(R, NAME, P1) R _6IT_THISCALLX(machine, NAME, P1)
#define MACHINE_METHODXX(R, NAME, P1, P2) R _6IT_THISCALLXX(machine, NAME, P1, P2)
#define MACHINE_METHODXXX(R, NAME, P1, P2, P3) R _6IT_THISCALLXXX(machine, NAME, P1, P2, P3)

//#define DEBUGGER_METHOD(NS, R, NAME) NAMESPACED_METHOD(debugger, NS, R, NAME) 
//#define DEBUGGER_METHODX(NS, R, NAME, P1) NAMESPACED_METHODX(debugger, NS, R, NAME, P1)
//#define DEBUGGER_METHODXX(NS, R, NAME, P1, P2) NAMESPACED_METHODXX(debugger, NS, R, NAME, P1, P2)
