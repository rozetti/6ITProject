...
DOWNCOMPILER_METHODX_CONST(int, downcompile_IFREQI, struct expression_t *expression)
{
...
DOWNCOMPILER_METHODX_CONST(int, downcompile_CONDITION_IFX, struct expression_t *expression)
{
	...
	{
		return downcompile_IFREQI(_This, _State, expression);
	}
